...
public class GrpcServerMock extends DataStoreGrpc.DataStoreImplBase {
    ...
    public void getSubmissionRatings(RatingsSubmissionRequest request, StreamObserver<RatingsSubmissionResponse> responseObserver) {
        ...
        Criterion criterion2 = Criterion.newBuilder()
                .setCriterionId(2)
                .setName("Criterion 2")
                .setDescription("Description for Criterion 2")
                .setArea("Area 2")
                .setCriteria("Criteria 2")
                .setSubcriteria("Subcriteria 2")
                .build();
        Criterion criterion3 = Criterion.newBuilder()
                .setCriterionId(3)
                .setName("Criterion 3")
                .setDescription("Description for Criterion 3")
                .setArea("Area 3")
                .setCriteria("Criteria 3")
                .setSubcriteria("Subcriteria 3")
                .build();
        ...
        RatingsSubmissionResponse ratingsResponse = RatingsSubmissionResponse.newBuilder()
                ...
                .addCriteria(criterion2)
                .addCriteria(criterion3)
