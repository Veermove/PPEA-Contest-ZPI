...
func (q *Queries) GetCriteriaForSubmission(ctx context.Context, contestID int32) ([]GetCriteriaForSubmissionRow, error) {
	rows, err := q.db.Query(ctx, getCriteriaForSubmission, contestID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
